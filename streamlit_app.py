...
if st.session_state.logged_in:
    ...
    if st.session_state.active_tab == "funds":
        st.markdown("## 💰 Funds Module")
        st.write("Here you can manage your funds. [Insert your logic here]")

    elif st.session_state.active_tab == "calculator":
        st.markdown("## 🧮 Calculator Module")
        st.write("Perform calculations here. [Insert your logic here]")

    elif st.session_state.active_tab == "unique_digit":
        st.markdown("## 🔢 Unique Digit Module")
        st.write("Generate or analyze unique digits. [Insert your logic here]")
